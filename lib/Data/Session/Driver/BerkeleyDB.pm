...
L<Data::Session::Driver::BerkeleyDB> allows L<Data::Session> to manipulate sessions via L<BerkeleyDB>.

To use this module do both of these:

=over 4

=item o Specify a driver of type BerkeleyDB, as Data::Session -> new(type => 'driver:BerkeleyDB ...')
