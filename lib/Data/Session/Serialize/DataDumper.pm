...
L<Data::Session::Serialize::DataDumper> allows L<Data::Session> to manipulate sessions with L<Data::Dumper>.

To use this module do this:

=over 4

=item o Specify a driver of type DataDumper as Data::Session -> new(type=> '... serialize:DataDumper')
