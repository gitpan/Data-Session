...
L<Data::Session::Serialize::FreezeThaw> allows L<Data::Session> to manipulate sessions with L<FreezeThaw>.

To use this module do this:

=over 4

=item o Specify a driver of type FreezeThaw as Data::Session -> new(type => '... serialize:FreezeThaw')
